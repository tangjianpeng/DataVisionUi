...
export default {
  ...
  data() {
    return {
      ...
      checkList: ['ym_id', 'province_name', 'manf_name', 'brand_name', 'manf_prop_name', 'brand_orig_name', 'segment_name', 'sub_model_name', 'segment_full_name', 'fuel_type_name', 'vehicle_func_name', 'engine_type_name', 'tran_type_name'],
      tableData: [],
      province: [],
      cityName: [],
      carBrand: [],
