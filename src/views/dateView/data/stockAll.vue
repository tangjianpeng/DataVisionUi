...
export default {
  ...
  data() {
    return {
      ...
      checkList: ['year_id','manf_name','brand_name','manf_prop_name','brand_orig_name','segment_name','sub_model_name','segment_full_name','vehicle_func_name'],
      tableData: [],
      province: [],
      cityName: [],
      carBrand: [],
