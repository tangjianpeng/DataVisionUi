    ...
    <div class="selectionBox">
      ...
      <div class="checkboxBox">
        ...
        <div class="checkbox_item">
          <el-checkbox-group v-model="checkList">
            <el-checkbox disabled label="year_id">年度</el-checkbox>
      ...
      <div class="table">
        <el-table
          ...
          style="width: 100%">
          <el-table-column
            v-if="checkList.includes('year_id')"
            prop="yearId"
            label="年度"
            width="100">
          </el-table-column>
...
<script>
import { dvIndustry, dvProvince, dvCity, dvCarBrand, carStockList,stockList, volumeList, dvCarSeries,dateRanges } from "@/api/data";
export default {
  name: '',
  data() {
    return {
      ...
      checkList: ['year_id','province_name','city_name','manf_name','brand_name','manf_prop_name','brand_orig_name','segment_name','sub_model_name','segment_full_name','vehicle_func_name'],
      tableData: [],
      province: [],
      cityName: [],
      carBrand: [],
  ...
  methods: {
    ...
    //   dvIndustry().then( res => {
    //     let data = res.data || []
    //     this.itemData.beginDate = '2020'
    //     this.itemData.endDate = '2020'
    //     this.carStockList()
    //   })
    // },
    ...
    dateRanges() {
      dateRanges().then(res=>{
        if(res.code == 200){
          ...
          let edata = res.data[0].endDate.split("-")[0];
          this.itemData.beginDate = edata;
          this.itemData.endDate = edata;
          this.carStockList();
        }
      })
    },
