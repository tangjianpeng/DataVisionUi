...
<script>
import { dvIndustry, dvProvince, dvCity, dvCarBrand, salesVolumeList, volumeList, dvCarSeries, energyNewList, carEnergyNewList,dateRanges } from "@/api/data";
export default {
  name: '',
  data() {
    return {
  ...
  methods: {
    ...
    salesVolumeList() {
      ...
      if(this.authority){
        carEnergyNewList(data).then( res => {
          this.loading = false;
