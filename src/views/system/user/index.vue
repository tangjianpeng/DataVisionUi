...
<!--          <el-table-column label="编号" align="center" prop="userId" />-->
          ...
          <el-table-column label="号码" align="center" prop="phonenumber" width="120" />
...
<!--            </el-form-item>-->
            ...
            <el-form-item label="用户类型" prop="deptId">
              <treeselect v-model="form.deptId" :options="deptOptions" :disable-branch-nodes="true" :show-count="true" placeholder="请选择用户类型" />
            </el-form-item>
...
<!--          </el-col>-->
<!--          <el-col :span="12">-->
            <el-form-item  v-hasPermi="['system:user:power']" label="用户权限">
...
import { treeselect,getDeptName } from "@/api/system/dept";
